...
PurpleAirAccessory.prototype = {
	...
	updateData: function (data) {
		...
		var pm10 = (parseFloat(dataA.pm10_0_atm) + parseFloat(dataB.pm10_0_atm)) / 2;
         		//adjust temp and humitity to account for heat generated by device. Values will now match PurpleAir Map rather than API. 
                var tempMod = dataA.temp_f - 8
                var humMod =  dataA.humidity * 1.10
                var tempC = (parseFloat(tempMod) - 32) * 5 / 9;
                var hum = parseFloat(humMod);
